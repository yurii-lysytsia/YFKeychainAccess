...
public let YFKeychainAccessErrorDomain = "YFKeychainAccess.error"

public enum YFStatus: OSStatus, Error {
    case success                            = 0
...
extension YFStatus: RawRepresentable, CustomStringConvertible {
    
    public init(_ status: OSStatus) {
        self = YFStatus(rawValue: status) ?? .unexpectedError
    }
...
extension YFStatus: CustomNSError {
    public static let errorDomain = YFKeychainAccessErrorDomain
